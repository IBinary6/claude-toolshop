...
|---|---|
| `hooks/js/claudemd_inject/claudemd_inject.js` | `~/.claude/hooks/js/claudemd_inject/claudemd_inject.js` |
...
# hooks
mkdir -p "$DEST/hooks/js/claudemd_inject" "$DEST/hooks/js/crg_build" \
         "$DEST/hooks/js/crg_update" "$DEST/hooks/js/graphify_build" \
         "$DEST/hooks/js/grep_nudge" "$DEST/hooks/js/lib"
cp "$REPO/hooks/js/claudemd_inject/claudemd_inject.js" "$DEST/hooks/js/claudemd_inject/"
    ...
    "SessionStart": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "node \"$HOME/.claude/hooks/js/claudemd_inject/claudemd_inject.js\"",
            "timeout": 5
          },
          {
            "type": "command",
...
node --check "$HOME/.claude/hooks/js/claudemd_inject/claudemd_inject.js"
...
```bash
rm -rf ~/.claude/hooks/js/claudemd_inject
